...
function Slider({
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="w-14 text-sm text-neutral-400 shrink-0 font-medium">
        {label}
      </span>
      <button
        type="button"
...
export default function Controls({
  ...
  return (
    <div
      className={`absolute left-0 right-0 z-20 bg-neutral-900/95 backdrop-blur-xl border-t border-neutral-800 pb-[env(safe-area-inset-bottom)] transition-transform duration-300 ease-out ${
